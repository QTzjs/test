...
var mizhu = new function() {
	...
	this.confirm1 = function(title, message, selected) {   //转盘提示框
		this._close = function(flag) {
			if(flag) {
				$(".win").remove();
				selected(flag);
		...
		var html = '<div class="win"><div class="mask-layer"></div><div class="window-panel"><iframe class="title-panel" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><div class="title"><h3 style="margin-top:10px;"></h3></div><div class="body-panel"><p class="content"></p><p class="btns"><button class="w-btn" tabindex="1" onclick="mizhu._close(false);">取消</button><button class="w-btn" onclick="mizhu._close(true);">确定</button></p></div></div></div>';
		messageBox(html, title, message);
	};
	this.confirm2 = function(title, message, selected) {  //注册会员提示框
		this._close = function(flag) {
			if(flag) {
				$(".win").remove();
				selected(flag);
	...
	this.alert = function(title, message, ico) {
		...
		var html = '<div class="win"><div class="mask-layer"></div><div class="window-panel"><iframe class="title-panel" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><div class="title"><h3 style=\"margin-top:10px;\"></h3></div><div class="body-panel">' + icon + '<p class="content"></p><p class="btns"><button class="w-btn" tabindex="1" onclick="mizhu.close();">确定</button></p></div></div></div>';
		messageBox(html, title, message);
	...
	this.alert2 = function(title, message, ico) {
		...
		var html = '<div class="win"><div class="mask-layer"></div><div class="window-panel"><iframe class="title-panel" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><div class="title"><h3 style=\"margin-top:10px;\"></h3></div><div class="body-panel">' + icon + '<p class="content"></p><p class="btns"><button class="w-btn" tabindex="1" onclick="mizhu.close2();">确定</button></p></div></div></div>';
		messageBox(html, title, message);
	...
	this.close2 = function() {
		...
		if(ele.innerHTML<100){
            this.confirm2("提示消息","您的积分小于100，是否立即充值？",function(flag){
					                  if(flag){
					                  window.location.href="WxPaycode.action?p_biao=1";
					                  }
