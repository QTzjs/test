...
<div class="box">
    <div class="login-box">
        ...
        <div class="login-content ">
            <div class="form">
                <form id="modifyPassword" class="form-horizontal" action="${pageContex.request.contextPath }loginlogin.action" method="post" enctype="multipart/form-data">
